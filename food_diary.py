...
class FoodDiary(QMainWindow):
    ...
    def setupUi(self, mainwindow):
        ...
        self.calory_count_label = QtWidgets.QLabel(self.formLayoutWidget)
        self.calory_count_label.setObjectName("calory_count_label")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.calory_count_label)
        self.protein_label = QtWidgets.QLabel(self.formLayoutWidget)
        self.protein_label.setObjectName("protein_label")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.protein_label)
        self.protein_count_label = QtWidgets.QLabel(self.formLayoutWidget)
        self.protein_count_label.setObjectName("protein_count_label")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.protein_count_label)
        self.fats_label = QtWidgets.QLabel(self.formLayoutWidget)
        self.fats_label.setObjectName("fats_label")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.fats_label)
        self.fats_count_label = QtWidgets.QLabel(self.formLayoutWidget)
        self.fats_count_label.setObjectName("fats_count_label")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.fats_count_label)
        self.carbohydrates_label = QtWidgets.QLabel(self.formLayoutWidget)
        self.carbohydrates_label.setObjectName("carbohydrates_label")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.carbohydrates_label)
        self.carbohydrates_count_label = QtWidgets.QLabel(self.formLayoutWidget)
        self.carbohydrates_count_label.setObjectName("carbohydrates_count_label")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.carbohydrates_count_label)
        self.calory_label_9 = QtWidgets.QLabel(self.formLayoutWidget)
        self.calory_label_9.setObjectName("calory_label_9")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.calory_label_9)
        self.breakfast_widget = QtWidgets.QWidget(self.centralwidget)
        self.breakfast_widget.setGeometry(QtCore.QRect(0, 170, 1331, 161))
        self.breakfast_widget.setObjectName("breakfast_widget")
        self.breakfast_label = QtWidgets.QLabel(self.breakfast_widget)
        self.breakfast_label.setGeometry(QtCore.QRect(0, 5, 1331, 21))
        self.breakfast_label.setObjectName("breakfast_label")
        self.products_widget_breakfast = QtWidgets.QWidget(self.breakfast_widget)
        ...
        self.write_food_breakfast_button = QtWidgets.QPushButton(self.breakfast_widget)
        ...
        self.write_food_lunch_button = QtWidgets.QPushButton(self.lunch_widget)
        ...
        self.write_food_dinner_button = QtWidgets.QPushButton(self.dinner_widget)
